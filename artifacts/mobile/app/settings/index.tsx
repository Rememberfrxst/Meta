...
const styles = StyleSheet.create({
  container: { flex: 1 },
  section: { padding: 16 },
  sectionTitle: { fontSize: 11, fontFamily: 'Inter_600SemiBold', letterSpacing: 1, marginBottom: 14 },
  ...
  themeSub: { fontSize: 10, fontFamily: 'Inter_400Regular', textAlign: 'center' },
  ...
  appLogoText: { fontSize: 28, fontFamily: 'Inter_700Bold', color: '#fff' },
  appName: { fontSize: 18, fontFamily: 'Inter_700Bold', letterSpacing: 3 },
  appTagline: { fontSize: 13, fontFamily: 'Inter_400Regular' },
  appVersion: { fontSize: 12, fontFamily: 'Inter_400Regular' },
  appCopy: { fontSize: 11, fontFamily: 'Inter_400Regular' },
});
