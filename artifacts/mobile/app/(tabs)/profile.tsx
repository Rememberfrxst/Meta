...
const styles = StyleSheet.create({
  ...
  userEmail: { fontSize: 13, fontFamily: 'Inter_400Regular', color: 'rgba(255,255,255,0.85)', marginTop: 2 },
  userPhone: { fontSize: 13, fontFamily: 'Inter_400Regular', color: 'rgba(255,255,255,0.75)', marginTop: 1 },
  ...
  sellerBadgeText: { fontSize: 11, fontFamily: 'Inter_600SemiBold', color: '#fff' },
  ...
  guestTitle: { fontSize: 18, fontFamily: 'Inter_600SemiBold' },
  guestSubtitle: { fontSize: 13, fontFamily: 'Inter_400Regular', textAlign: 'center' },
  ...
  sectionHeader: { fontSize: 11, fontFamily: 'Inter_600SemiBold', paddingHorizontal: 20, paddingTop: 16, paddingBottom: 6, letterSpacing: 1 },
  ...
  langPillText: { fontSize: 12, fontFamily: 'Inter_700Bold' },
