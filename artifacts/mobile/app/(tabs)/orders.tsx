...
const styles = StyleSheet.create({
  ...
  orderId: { fontSize: 15, fontFamily: 'Inter_600SemiBold' },
  ...
  orderItemNames: { fontSize: 12, fontFamily: 'Inter_400Regular' },
  ...
  estDelivery: { fontSize: 12, fontFamily: 'Inter_500Medium' },
