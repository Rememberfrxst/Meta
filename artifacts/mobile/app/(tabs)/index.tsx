...
const styles = StyleSheet.create({
  ...
  location: { fontSize: 12, fontFamily: 'Inter_500Medium', color: 'rgba(255,255,255,0.9)', maxWidth: 180 },
  ...
  searchHint: { flex: 1, fontSize: 14, fontFamily: 'Inter_400Regular' },
  stripe: { paddingVertical: 8, paddingHorizontal: 16 },
  stripeText: { color: '#fff', fontSize: 12, fontFamily: 'Inter_500Medium', textAlign: 'center' },
  ...
  dealBadgeText: { color: '#fff', fontSize: 10, fontFamily: 'Inter_700Bold', letterSpacing: 1 },
