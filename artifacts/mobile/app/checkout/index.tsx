        ...
        <View style={[styles.section, { backgroundColor: colors.card, marginTop: 8 }]}>
          ...
          {paymentMethod === 'upi' && (
            <View style={styles.upiInput}>
              <TextInput
                style={[styles.upiField, { backgroundColor: colors.input, color: colors.foreground, borderColor: colors.border, fontFamily: 'GoogleSans_400Regular' }]}
...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: 18, fontFamily: 'GoogleSans_500Medium' },
  shopBtn: { paddingHorizontal: 28, paddingVertical: 14, borderRadius: 12 },
  shopBtnText: { fontSize: 15, fontFamily: 'GoogleSans_600SemiBold' },
  section: { padding: 16 },
  ...
  defaultText: { fontSize: 9, fontFamily: 'GoogleSans_700Bold', letterSpacing: 1 },
  ...
  changeAddrText: { fontSize: 14, fontFamily: 'GoogleSans_600SemiBold' },
  ...
  paymentInfo: { flex: 1 },
  paymentLabel: { fontSize: 15, fontFamily: 'GoogleSans_600SemiBold' },
  paymentSub: { fontSize: 12, fontFamily: 'GoogleSans_400Regular', marginTop: 2 },
  ...
  razorpayText: { fontSize: 12, fontFamily: 'GoogleSans_400Regular' },
  summaryItem: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  summaryItemName: { flex: 1, fontSize: 13, fontFamily: 'GoogleSans_400Regular', marginRight: 8 },
  summaryItemPrice: { fontSize: 13, fontFamily: 'GoogleSans_500Medium' },
  ...
  footerMethod: { fontSize: 12, fontFamily: 'GoogleSans_400Regular' },
  placeBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingVertical: 16, borderRadius: 14 },
  placeBtnText: { fontSize: 16, fontFamily: 'GoogleSans_600SemiBold' },
});
