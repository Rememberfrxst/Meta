...
const styles = StyleSheet.create({
  ...
  brandName: { fontSize: 22, fontFamily: 'Inter_700Bold', letterSpacing: 3 },
  tagline: { fontSize: 13, fontFamily: 'Inter_400Regular' },
  title: { fontSize: 26, fontFamily: 'Inter_700Bold', marginTop: 8 },
  ...
  hintText: { fontSize: 13, fontFamily: 'Inter_500Medium', flex: 1 },
